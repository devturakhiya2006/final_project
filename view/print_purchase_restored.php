...
<head>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; font-family: 'Segoe UI', Arial, sans-serif; font-size:10px; line-height:1.4; }
    ...
    .customer-details { background:#fcfcfc; padding:12px; margin-bottom:15px; border: 1px solid #eee; border-left:4px solid #d9534f; border-radius: 3px; }
...
<body>
  <div class="invoice-container" id="invoice">
    ...
    <div class="customer-details">
      ...
      <div class="form-row">
        <div class="form-group">
            ...
            <span class="field-value"><?php echo e($inv['vendor_name']); ?></span>
        </div>
        <div class="form-group">
            <span class="field-label">GSTIN:</span>
            <span class="field-value"><?php echo e($inv['vendor_gst'] ?? 'N/A'); ?></span>
        </div>
      </div>
      <div class="form-row">
        <div class="form-group">
            <span class="field-label">Address:</span>
            <span class="field-value"><?php echo e($inv['vendor_address'] ?? 'N/A'); ?></span>
        </div>
      </div>
    </div>
    ...
    <div class="form-row">
      <div class="form-group">
        <div class="bank-details" style="min-height: 120px;">
          <h2>Bank Details</h2>
          <div style="flex: 1;">
            <div class="form-row">
                <div class="form-group"><span class="field-label">Bank:</span> <span class="field-value"><?php echo e($inv['bank_name'] ?? 'N/A'); ?></span></div>
                <div class="form-group"><span class="field-label">Branch:</span> <span class="field-value"><?php echo e($inv['bank_branch'] ?? 'N/A'); ?></span></div>
            </div>
            <div class="form-row">
                <div class="form-group"><span class="field-label">A/C Name:</span> <span class="field-value"><?php echo e($inv['account_name'] ?? 'N/A'); ?></span></div>
                <div class="form-group"><span class="field-label">A/C No:</span> <span class="field-value"><?php echo e($inv['account_number'] ?? 'N/A'); ?></span></div>
            </div>
            <div class="form-row">
                <div class="form-group"><span class="field-label">IFSC:</span> <span class="field-value"><?php echo e($inv['ifsc_code'] ?? 'N/A'); ?></span></div>
                <div class="form-group"><span class="field-label">UPI ID:</span> <span class="field-value"><?php echo e($inv['upi_id'] ?? 'N/A'); ?></span></div>
            </div>
          </div>
            <?php if(!empty($inv['qr_code_path'])): ?>
            <div style="margin-left: 20px; text-align: center;">
              <img src="<?php echo e($inv['qr_code_path']); ?>" style="height: 100px; width: 100px; object-fit: contain; border: 1px solid #eee; padding: 5px;">
              <p style="font-size: 8px; margin-top: 4px;">Payment QR Code</p>
            </div>
            <?php endif; ?>
        </div>
      </div>
